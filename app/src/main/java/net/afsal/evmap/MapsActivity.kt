...
import net.afsal.evmap.fragment.MapFragmentArgs
import net.afsal.evmap.model.ChargeLocation
import net.afsal.evmap.navigation.NavHostFragment
import net.afsal.evmap.storage.PreferenceDataSource
import net.afsal.evmap.utils.getLocationFromIntent
...
class MapsActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        } else if (intent.scheme == "net.afsal.evmap") {
            intent.data?.let {
