...
import net.afsal.evmap.adapter.iconForPlaceType
import net.afsal.evmap.adapter.isSpecialPlace
import net.afsal.evmap.autocomplete.ApiUnavailableException
import net.afsal.evmap.autocomplete.AutocompletePlace
import net.afsal.evmap.autocomplete.AutocompleteProvider
import net.afsal.evmap.autocomplete.PlaceWithBounds
import net.afsal.evmap.autocomplete.getAutocompleteProviders
import net.afsal.evmap.storage.AppDatabase
import net.afsal.evmap.storage.PreferenceDataSource
import net.afsal.evmap.storage.RecentAutocompletePlace
