...
import net.afsal.evmap.api.goingelectric.GEChargeCard
import net.afsal.evmap.api.goingelectric.GEChargepoint
import net.afsal.evmap.api.openchargemap.OCMConnectionType
import net.afsal.evmap.api.openchargemap.OCMCountry
import net.afsal.evmap.api.openchargemap.OCMOperator
