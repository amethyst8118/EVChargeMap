...
import net.afsal.evmap.api.goingelectric.GEChargerPhotoAdapter
import net.afsal.evmap.api.nobil.NobilChargerPhotoAdapter
import net.afsal.evmap.api.openchargemap.OCMChargerPhotoAdapter
import net.afsal.evmap.api.openstreetmap.ImgurChargerPhoto
import net.afsal.evmap.autocomplete.AutocompletePlaceType
