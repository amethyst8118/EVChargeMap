...
import net.afsal.evmap.MapsActivity
import net.afsal.evmap.R
import net.afsal.evmap.adapter.ConnectorAdapter
import net.afsal.evmap.adapter.DetailsAdapter
import net.afsal.evmap.adapter.GalleryAdapter
import net.afsal.evmap.adapter.PlaceAutocompleteAdapter
import net.afsal.evmap.api.chargeprice.ChargepriceApi
import net.afsal.evmap.autocomplete.ApiUnavailableException
import net.afsal.evmap.autocomplete.PlaceWithBounds
import net.afsal.evmap.bold
import net.afsal.evmap.databinding.FragmentMapBinding
import net.afsal.evmap.location.FusionEngine
import net.afsal.evmap.location.LocationEngine
import net.afsal.evmap.location.Priority
import net.afsal.evmap.model.ChargeLocation
import net.afsal.evmap.model.ChargepointListItem
import net.afsal.evmap.model.ChargerPhoto
import net.afsal.evmap.model.FILTERS_CUSTOM
import net.afsal.evmap.model.FILTERS_DISABLED
import net.afsal.evmap.model.FILTERS_FAVORITES
import net.afsal.evmap.navigation.safeNavigate
import net.afsal.evmap.shouldUseImperialUnits
import net.afsal.evmap.storage.PreferenceDataSource
import net.afsal.evmap.ui.HideOnScrollFabBehavior
import net.afsal.evmap.ui.MarkerManager
import net.afsal.evmap.ui.setTouchModal
import net.afsal.evmap.utils.boundingBox
import net.afsal.evmap.utils.checkAnyLocationPermission
import net.afsal.evmap.utils.checkFineLocationPermission
import net.afsal.evmap.utils.distanceBetween
import net.afsal.evmap.utils.formatDecimal
import net.afsal.evmap.viewmodel.GalleryViewModel
import net.afsal.evmap.viewmodel.MapPosition
import net.afsal.evmap.viewmodel.MapViewModel
import net.afsal.evmap.viewmodel.Resource
import net.afsal.evmap.viewmodel.Status
