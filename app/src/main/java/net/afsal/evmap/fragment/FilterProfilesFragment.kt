...
import net.afsal.evmap.adapter.FilterProfilesAdapter
import net.afsal.evmap.databinding.FragmentFilterProfilesBinding
import net.afsal.evmap.databinding.ItemFilterProfileBinding
import net.afsal.evmap.storage.FilterProfile
import net.afsal.evmap.ui.showEditTextDialog
import net.afsal.evmap.viewmodel.FilterProfilesViewModel
