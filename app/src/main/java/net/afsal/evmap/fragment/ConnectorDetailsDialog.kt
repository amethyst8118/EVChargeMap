...
import net.afsal.evmap.adapter.ConnectorDetailsAdapter
import net.afsal.evmap.adapter.SingleViewAdapter
import net.afsal.evmap.api.availability.ChargeLocationStatus
import net.afsal.evmap.databinding.DialogConnectorDetailsBinding
import net.afsal.evmap.databinding.DialogConnectorDetailsHeaderBinding
