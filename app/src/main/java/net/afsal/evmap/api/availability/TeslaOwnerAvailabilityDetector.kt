...
import net.afsal.evmap.api.availability.tesla.ChargerAvailability
import net.afsal.evmap.api.availability.tesla.TeslaAuthenticationApi
import net.afsal.evmap.api.availability.tesla.TeslaChargingOwnershipGraphQlApi
import net.afsal.evmap.api.availability.tesla.asTeslaCoord
