package net.afsal.evmap.api.goingelectric
...
import net.afsal.evmap.BuildConfig
import net.afsal.evmap.R
import net.afsal.evmap.addDebugInterceptors
import net.afsal.evmap.api.ChargepointApi
import net.afsal.evmap.api.ChargepointList
import net.afsal.evmap.api.FiltersSQLQuery
import net.afsal.evmap.api.FullDownloadResult
import net.afsal.evmap.api.StringProvider
import net.afsal.evmap.api.mapPower
import net.afsal.evmap.api.mapPowerInverse
import net.afsal.evmap.api.nameForPlugType
import net.afsal.evmap.api.powerSteps
import net.afsal.evmap.model.BooleanFilter
import net.afsal.evmap.model.ChargeLocation
import net.afsal.evmap.model.Chargepoint
import net.afsal.evmap.model.ChargepointListItem
import net.afsal.evmap.model.Filter
import net.afsal.evmap.model.FilterValue
import net.afsal.evmap.model.FilterValues
import net.afsal.evmap.model.MultipleChoiceFilter
import net.afsal.evmap.model.MultipleChoiceFilterValue
import net.afsal.evmap.model.ReferenceData
import net.afsal.evmap.model.SliderFilter
import net.afsal.evmap.model.getBooleanValue
import net.afsal.evmap.model.getMultipleChoiceValue
import net.afsal.evmap.model.getSliderValue
import net.afsal.evmap.viewmodel.Resource
import net.afsal.evmap.viewmodel.getClusterDistance
