package net.afsal.evmap.adapter
...
import net.afsal.evmap.api.availability.tesla.Rates
import net.afsal.evmap.bold
import net.afsal.evmap.joinToSpannedString
...
import net.afsal.evmap.ui.currency
